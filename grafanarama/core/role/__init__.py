...
class Spec(BaseModel):
    ...
    displayName: Optional[str] = Field(None, description='Optional display')
    groupName: Optional[str] = Field(None, description='Name of the team.')
    description: Optional[str] = Field(None, description='Role description')
    hidden: Union[Hidden, bool] = Field(..., description='Do not show this role')
